...
<body onload="prettyPrint();">
	...
	<ul id="org" style="display: none">
		<li id="${component.l1Component.id}"><a
			href="../../l1/view/${component.l1Component.id}">${component.l1Component.functionName}</a>
			<ul>
				<li><a href="./../../l2component/view/${component.id}" id="currentNode">${component.functionName}</a>
					<ul>
