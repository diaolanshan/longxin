...
public class ModuleController
{
	...
	public String updateModuleDescription(@ModelAttribute("module") Module module ,Model model)
	{
	...
	public String addL1Componment(@PathVariable int moduleId , L1Component l1Component)
	{
		Module module = moduleService.getModuleByID(moduleId);
